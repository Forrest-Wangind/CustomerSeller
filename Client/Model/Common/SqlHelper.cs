...
namespace SQLHelper
{
    ...
    public sealed class SqlServerHelper
    {
        ...
        public static SqlConnection Con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBConnection"].ConnectionString); 
        ...
        public static System.Data.SqlClient.SqlParameter MakeInParam(string paramName, object dbValue)
        {
            return new System.Data.SqlClient.SqlParameter(paramName, PrepareParameter(dbValue, false));
        }
        ...
        {
            return new System.Data.SqlClient.SqlParameter(paramName, PrepareParameter(dbValue, convertZeroToDBNull));
        }
